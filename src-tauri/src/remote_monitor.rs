...
MXEND	diskstats
MXBEGIN	net_route
default via 10.0.3.1 dev eno1 proto dhcp src 10.0.3.20 metric 100
MXEND	net_route
MXBEGIN	net_addr
2: eno1    inet 10.0.3.20/24 brd 10.0.3.255 scope global eno1
...
MXEND	net_sys
MXBEGIN	net_route
default via 10.0.3.1 dev eno1 src 10.0.3.20
MXEND	net_route
MXBEGIN	net_addr
2: eno1    inet 10.0.3.20/24 scope global eno1
MXEND	net_addr
MXBEGIN	net_dev
Inter-|   Receive                                                |  Transmit
 face |bytes    packets errs drop fifo frame compressed multicast|bytes    packets errs drop fifo colls carrier compressed
