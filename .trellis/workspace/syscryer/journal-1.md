...
Added remote MCP supervision and logs, unified MCP SFTP transfers with resumable mxpart behavior, verified real transfers against 10.0.0.16, and added updater confirmation plus MCP blocker termination.
